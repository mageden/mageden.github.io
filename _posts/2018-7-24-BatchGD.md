...
<img src="/images/BatchGD/simple_illustration.png" width="100%" style="padding:0px"/>
...
<img src="/images/BatchGD/convex_nonconvex.png" width="100%" style="padding:0px"/>
...
There are more advanced methods that adjust the learning rate across iterations in order to speed up convergence, such as annealing and backpropagation, which are used in almost all real world implementations. This post just covers the simplest case in order to teach the basics of how the algorithm works.
...
<img src="/images/BatchGD/standardized.png" width="100%" style="padding:0px"/>
...
A standard linear regression with n=100 was simulated according to the following model;
...
<img src="/images/BatchGD/linear_regression.png" width="100%" style="padding:0px"/>
...
<img src="/images/BatchGD/lr_cost.png" width="100%" style="padding:0px"/>
...
Here I used $a=1$ and $b=100$ so that the global minimum was located at $x_1=1$ and $x_2=1$. The maximum iterations was 10000 and $\tau=10^{-8}$.

<img src="/images/BatchGD/rosenbrock.png" width="100%" style="padding:0px"/>
...
<img src="/images/BatchGD/rosenbrock_cost.png" width="100%" style="padding:0px"/>
