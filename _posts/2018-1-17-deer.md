...
<img src="/images/deer_ts_accidents.png" width="100%" style="padding:2px"/>

By explicitly breaking down the series into approximate seasonal, trend, and random compenents we are able to see that there is a slight upward trend and the proportion of random noise to our signal is low. The "random" competent displays some heteroskedasticity which may be problematic for modeling. The log is taken of the data and it is broken down into components again as seen in the right figure. The random component now appears acceptable. There was no missing data or apparent outliers in the dataset, and so we move forward to some models.

<img src="/images/deer_decomp_plot.png" width="100%" style="padding:2px"/>
...
<img src="/images/deer_lm_simple_diag.png" width="100%" style="padding:2px"/>
...
<img src="/images/deer_lm_ar_diag.png" width="100%" style="padding:2px"/>
...
<img src="/images/deer_log_differencing.png" width="49%" style="padding:2px"/>
...
<img src="/images/deer_forecast_plots.png" width="100%" style="padding:2px"/>
